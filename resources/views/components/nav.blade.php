<nav class="flex items-center justify-between flex-wrap bg-teal-500 p-3">
    ...
    <div id="navbarMobile" class="w-full hidden flex-grow lg:flex lg:items-center lg:w-auto">
        <div class="text-sm lg:flex-grow">
            <a href="{{ route('browse') }}" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
                browse all ads
            </a>
            <a href="{{ route('post') }}" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
                post an ad
            </a>
        </div>
    </div>
